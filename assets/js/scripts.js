...
class WordCounter {
	...
	getKeywordDensity() {
		try {
			...
			console.error("Error while calculating keyword density: " + error);
			return {};
		}
	}
}
...
jQuery(document).ready(function ($) {
    ...
    function sanitizeUserInput() {
        ...
        let sanitizedText = userText.replace(/<.*?>/g, ""); // This is a simple regex to remove HTML tags
        return sanitizedText;
    }

    // Handle the focus event of the textarea
    $('#userText').on('focus', function() {
        sanitizeUserInput();
    });
